...
As part of my work, I analyzed the VideoShop system.

I propose a small extension: a reservation feature.

Users could reserve products for a short time before buying them. This prevents items from being sold out during checkout.

This shows an understanding of how the system works and how it could be improved.
